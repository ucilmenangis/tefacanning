<x-filament-panels::page>
    <div class="space-y-6">
        {{-- Header Info --}}
        <div class="p-6 rounded-2xl bg-gradient-to-br from-red-50 to-red-100 dark:from-red-900/30 dark:to-red-800/20 border border-red-200 dark:border-red-800">
            <div class="flex items-start gap-4">
                ...
                <div>
                    ...
                    <p class="text-sm text-red-600 dark:text-red-400 mt-1">
                        Selamat datang, <strong>{{ auth('customer')->user()->name }}</strong>! Silakan pilih batch produksi dan produk yang tersedia untuk melakukan pre-order.
                    </p>
                    <div class="flex flex-wrap gap-3 mt-3">
                        <span class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-medium bg-red-200 dark:bg-red-800 text-red-800 dark:text-red-200">
                        ...
                        <span class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-medium bg-emerald-200 dark:bg-emerald-800 text-emerald-800 dark:text-emerald-200">
                            <svg class="w-3 h-3" fill="currentColor" viewBox="0 0 8 8"><circle cx="4" cy="4" r="3"/></svg>
                            Ambil di Kampus
                        </span>
                    </div>
    ...
    <div class="mt-8">
        ...
        @if($orders->isEmpty())
            <div class="text-center py-6 rounded-xl bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700">
                <div class="flex items-center justify-center mb-2">
                    <x-heroicon-o-inbox class="w-4 h-4 text-gray-400" />
                </div>
                <p class="text-sm text-gray-500 dark:text-gray-400">Belum ada pesanan. Silakan buat pre-order pertama Anda!</p>
            </div>
        @else
            <div class="space-y-3">
                    ...
                    <div class="p-4 rounded-xl bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-sm">
                        <div class="flex items-center justify-between mb-2">
                            <div class="flex items-center gap-3">
                                ...
                                @endphp
                                <span class="px-2.5 py-0.5 rounded-full text-xs font-medium {{ $statusColors[$order->status] ?? '' }}">
