                ...
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-amber-700 dark:text-amber-300 mt-1">
                            Anda memiliki pesanan yang sedang diproses. Data profil tidak dapat diubah untuk menjaga konsistensi data pesanan.
                        ...
                        <div class="mt-3 space-y-1">
                            @foreach($this->getActiveOrdersInfo() as $order)
                                <div class="flex items-center gap-2 text-sm">
                                    ...
                                    <span class="font-mono text-amber-800 dark:text-amber-300">{{ $order['order_number'] }}</span>
                                </div>
                            @endforeach
                        </div>
                    </div>
