            ...
            <div class="space-y-3">
                ...
                <div class="grid grid-cols-2 gap-3">
                    <div class="p-3 rounded-lg bg-gray-50 dark:bg-gray-800">
                        <p class="text-[10px] uppercase tracking-wider text-gray-500 dark:text-gray-400 font-semibold">Acara</p>
                        <p class="text-sm font-medium text-gray-900 dark:text-white mt-0.5">{{ $batch['event_name'] }}</p>
                    </div>
                    <div class="p-3 rounded-lg bg-gray-50 dark:bg-gray-800">
                        <p class="text-[10px] uppercase tracking-wider text-gray-500 dark:text-gray-400 font-semibold">Tanggal</p>
                        <p class="text-sm font-medium text-gray-900 dark:text-white mt-0.5">{{ $batch['event_date'] }}</p>
                    </div>
                </div>

                <div class="flex items-center gap-2 p-3 rounded-lg bg-red-50 dark:bg-red-900/20 border border-red-100 dark:border-red-800">
                ...
                <a href="/customer/pre-order" class="block w-full text-center px-4 py-2 rounded-lg text-sm font-medium text-white bg-red-600 hover:bg-red-700 transition">
                    Buat Pre-Order →
                </a>
            </div>
        @else
