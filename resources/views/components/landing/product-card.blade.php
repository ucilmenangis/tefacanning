...
<div
    class="product-card group bg-white rounded-2xl border border-gray-100 hover:border-brand-200 hover:shadow-xl hover:shadow-brand-50 transition-all duration-300 overflow-hidden fade-in fade-in-delay-{{ $delay }}">
    ...
    <div class="p-6">
        <div class="flex items-center gap-2 mb-3">
            <span
                class="text-[10px] font-bold text-white bg-{{ $badgeColor }} px-2.5 py-1 rounded-full uppercase tracking-wide">{{ $badge }}</span>
